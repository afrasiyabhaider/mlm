    ...
    <ul class="navbar-nav ml-auto flex-row">
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" id="userProfileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="<?php echo e(get_image(config('constants.admin.profile.path') .'/'. auth()->guard('admin')->user()->image)); ?>" alt="user-image">
            </a>
...
</div><?php /**PATH G:\Wamps\wamp64\www\freelance\mlm\core\resources\views/admin/partials/topnav.blade.php ENDPATH**/ ?>