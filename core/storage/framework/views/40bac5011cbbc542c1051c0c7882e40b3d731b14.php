    ...
    <ul class="navbar-nav ml-auto flex-row">
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" id="userProfileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="<?php echo e(get_image(config('constants.user.profile.path') .'/'. Auth::user()->image)); ?>" alt="user-image">
            </a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userProfileDropdown">
                ...
                <a class="dropdown-item" href="<?php echo e(route('user.logout')); ?>"><i class="fa fa-sign-out"></i><?php echo app('translator')->get('Logout'); ?></a>
            </div>
        </li>
    </ul>
</div>
<?php /**PATH G:\Wamps\wamp64\www\freelance\mlm\core\resources\views/templates/tmp2/partials/topnav.blade.php ENDPATH**/ ?>