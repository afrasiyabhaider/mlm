        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="clearfix">
                    ...
                    <span class="float-right text-muted"><?php echo e($general->cur_sym); ?><?php echo e(formatter_money($user->balance)); ?></span>
                </p>
                <p class="clearfix">
                    <span class="float-left">Refer By</span>
                    <span class="float-right text-muted"><?php echo e(isset($refer->username) ? $refer->username : "None"); ?></span>
                </p>
                <p class="clearfix">
                    <span class="float-left">Subscribe Plan</span>
                    <span class="float-right text-muted"><?php echo e(isset($plan->name) ? $plan->name : "None"); ?></span>
                </p>
                <p class="clearfix">
                    <span class="float-left">Joined</span>
                    <span class="float-right text-muted"><?php echo e(show_datetime($user->created_at)); ?></span>
                </p>
    ...
    <div class="col-lg-9">       
        <div class="card">
            ...
            <div class="row p-4">
                ...
                <div class="col-lg-4">
                    <a href="<?php echo e(route('admin.users.ref.single', $user->id)); ?>" class="text-white text-center btn-block">
                ...
                <div class="col-lg-4">
                    <a href="<?php echo e(route('admin.users.matrix.single',['lv_no' => 1, $user->id])); ?>" class="text-white text-center btn-block">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Wamps\wamp64\www\freelance\mlm\core\resources\views/admin/users/detail.blade.php ENDPATH**/ ?>