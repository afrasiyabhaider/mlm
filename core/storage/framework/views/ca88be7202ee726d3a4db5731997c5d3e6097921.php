        ...
        <ul class="nav">
            ...
            <li class="nav-item <?php echo e(sidenav_active('admin.manage-pin')); ?><?php echo e(sidenav_active('admin.used-pin')); ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item <?php echo e(sidenav_active('admin.used-pin')); ?>">
                        <a class="nav-link" href="<?php echo e(route('admin.used-pin')); ?>">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
...
<?php /**PATH G:\Wamps\wamp64\www\freelance\mlm\core\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>