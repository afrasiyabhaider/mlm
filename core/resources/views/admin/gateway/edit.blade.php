                            ...
                            <div class="payment-method-item child--item">
                                <div class="payment-method-header d-flex flex-wrap">
                                    ...
                                    <div class="content">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4 class="mb-3">{{ $gateway_currency->method->name }} - {{ $gateway_currency->currency }}</h4>
                                            ...
                                            <div class="card outline-primary">
                                                ...
                                                <div class="card-body">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="0" name="currency[{{ $currency_idx }}][fixed_charge]" value="{{ formatter_money($gateway_currency->fixed_charge, 'crypto') }}" required/>
                                                    </div>
                                                    <div class="input-group">
