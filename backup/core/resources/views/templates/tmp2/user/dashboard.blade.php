...
<div class="alert">
    ...
    <strong>Congratulations For Signing up!</strong>
    <hr> Deposit your $50 to Buy your Membership Slot and get activated. <a href="referrals"
        class="btn btn-sm btn-neutral">See Referrals Details Here</a>
</div>
@endif
@if(auth()->user()->plan_id == 1 && count(auth()->user()->referal()->get()) < 3)
<div class="alert1">
    <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
    <strong>Yeah! You Did it!</strong>
    <hr> You have Just activate the {{auth()->user()->plan()->first()->name}} in ${{auth()->user()->plan()->first()->price}}. The Next Task is to refer 3 people. <a href="referrals"
        class="btn btn-sm btn-neutral">Click Here To See Referral Details</a>
</div>
@endif
...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice bg-info border-radius-5">
            <div class="details">
                <h4 class="amount mb-2 font-weight-bold">{{$general->cur_sym}}{{formatter_money($total_withdraw)}} </h4>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice bg-dark border-radius-5">
            <div class="details">
                <h4 class="amount mb-2 font-weight-bold">{{$general->cur_sym}}{{formatter_money($total_epin_recharge)}}
                </h4>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6">
        <div class="dashboard-w2 slice bg-default border-radius-5">
            <div class="details">
                <h4 class="amount mb-2 font-weight-bold">{{$general->cur_sym}}{{formatter_money($total_epin_generate)}}
                </h4>
